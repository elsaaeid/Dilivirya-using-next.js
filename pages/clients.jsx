...
export default function ClientsPage({ sidebarOpen, handleMenuToggle }) {
  return (
        ...
        <table className="admins-table">
          ...
          <tbody>
            <tr>
              ...
              <td data-label="Phone">01012345678</td>
            ...
            <tr>
              ...
              <td data-label="Phone">01087654321</td>
              <td data-label="City">Alexandria</td>
